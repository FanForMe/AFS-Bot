...
.addField('     **كت تويت** ' , '**يعطيك سؤال هادف او محزن**')
.addField('     **الجديد ** ' ,' ** لرؤية ما تم اضافته على البوت في الفترة الاخيرة ** ')
.addField('     **soon ** ' ,' **  soon  ** ')
